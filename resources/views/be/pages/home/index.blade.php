...
@endsection
@push('before-style')
<link href="{{ asset('/asset/dashboard/assets/libs/flatpickr/flatpickr.min.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('/asset/dashboard/assets/libs/selectize/css/selectize.bootstrap3.css') }}" rel="stylesheet" type="text/css" />
@endpush
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{ asset('/asset/dashboard/assets/images/users/user-2.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{ asset('/asset/dashboard/assets/images/users/user-3.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{ asset('/asset/dashboard/assets/images/users/user-4.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{ asset('/asset/dashboard/assets/images/users/user-5.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="{{ asset('/asset/dashboard/assets/images/users/user-6.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
...
<script src="{{ asset('/asset/dashboard/assets/libs/flatpickr/flatpickr.min.js') }}"></script>
<script src="{{ asset('/asset/dashboard/assets/libs/apexcharts/apexcharts.min.js') }}"></script>
<script src="{{ asset('/asset/dashboard/assets/libs/selectize/js/standalone/selectize.min.js') }}"></script>

<!-- Dashboar 1 init js-->
<script src="{{ asset('/asset/dashboard/assets/js/pages/dashboard-1.init.js') }}"></script>
@endpush
